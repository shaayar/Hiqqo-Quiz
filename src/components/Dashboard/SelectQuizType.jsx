...
const QuizTypeModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      ...
      <input type="text" name="quiz-title" className="pl-2 m-2 ml-0 border rounded-lg cursor-pointer w-full" onChange={(e)=>setQuizTitle(e.target.value)} value={quizTitle} />
        ...
        <div className="flex justify-end space-x-2 mt-4">
          ...
          <button className="px-4 py-2 bg-black text-white rounded-lg" onClick={handleSubmit}>Select & Next</button>
        </div>
        {error && (
